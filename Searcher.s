...
// lu: Jul-3-2026
@search_google_main(0, 1, 'When was ' + @get_sj + ' invented?');
}
...
// lu: Jul-3-2026 From my experimentation, I am unable to turn off safe search using a
// command ran from Multi-Edit. If I run the command using cbf 'google', I am able to turn
// off safe search.
@search_google_main(0, 1, @get_sj + ' nude photos');
}
...
// lu: Jun-1-2026
@search_google_main(0, 0, 'What is the story behind ' + @get_sj + '?');
}
...
// lu: May-26-2026
@search_google_main(0, 0, 'What is the opposite of ' + @get_sj + '?');
}
